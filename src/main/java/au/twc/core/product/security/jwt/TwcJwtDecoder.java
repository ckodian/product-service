//package au.twc.core.product.security.jwt;
//
...
//
//public class TwcJwtDecoder implements JwtDecoder {
//
...
//
//    /**
//     * Configures a {@link TwcJwtDecoder} with the given parameters
//     *
//     * @param jwtProcessor - the {@link JWTProcessor} to use
//     */
//    public TwcJwtDecoder(JWTProcessor<SecurityContext> jwtProcessor) {
...
//     * @return a {@link TwcJwtDecoder.JwkSetUriJwtDecoderBuilder} for further configurations
//     */
//    public static TwcJwtDecoder.JwkSetUriJwtDecoderBuilder withJwkSetUri(String jwkSetUri) {
//        return new TwcJwtDecoder.JwkSetUriJwtDecoderBuilder(jwkSetUri);
//    }
//
//    /**
...
//     * @return a {@link TwcJwtDecoder.PublicKeyJwtDecoderBuilder} for further configurations
//     */
//    public static TwcJwtDecoder.PublicKeyJwtDecoderBuilder withPublicKey(RSAPublicKey key) {
//        return new TwcJwtDecoder.PublicKeyJwtDecoderBuilder(key);
//    }
//
//    /**
...
//     * @return a {@link TwcJwtDecoder.SecretKeyJwtDecoderBuilder} for further configurations
//     */
//    public static TwcJwtDecoder.SecretKeyJwtDecoderBuilder withSecretKey(SecretKey secretKey) {
//        return new TwcJwtDecoder.SecretKeyJwtDecoderBuilder(secretKey);
//    }
//
//    /**
//     * A builder for creating {@link TwcJwtDecoder} instances based on a
...
//         * @return a {@link TwcJwtDecoder.JwkSetUriJwtDecoderBuilder} for further configurations
//         */
//        public TwcJwtDecoder.JwkSetUriJwtDecoderBuilder jwsAlgorithm(SignatureAlgorithm signatureAlgorithm) {
...
//         * @return a {@link TwcJwtDecoder.JwkSetUriJwtDecoderBuilder} for further configurations
//         */
//        public TwcJwtDecoder.JwkSetUriJwtDecoderBuilder jwsAlgorithms(Consumer<Set<SignatureAlgorithm>> signatureAlgorithmsConsumer) {
...
//         * @return
//         */
//        public TwcJwtDecoder.JwkSetUriJwtDecoderBuilder restOperations(RestOperations restOperations) {
...
//            ResourceRetriever jwkSetRetriever = new TwcJwtDecoder.JwkSetUriJwtDecoderBuilder.RestOperationsResourceRetriever(this.restOperations);
...
//
//        /**
//         * Build the configured {@link TwcJwtDecoder}.
//         *
//         * @return the configured {@link TwcJwtDecoder}
//         */
//        public TwcJwtDecoder build() {
//            return new TwcJwtDecoder(processor());
//        }
//
...
//
//    /**
//     * A builder for creating {@link TwcJwtDecoder} instances based on a public key.
//     */
...
//         * @return a {@link TwcJwtDecoder.PublicKeyJwtDecoderBuilder} for further configurations
//         */
//        public TwcJwtDecoder.PublicKeyJwtDecoderBuilder signatureAlgorithm(SignatureAlgorithm signatureAlgorithm) {
//            Assert.notNull(signatureAlgorithm, "signatureAlgorithm cannot be null");
...
//
//    /**
//     * A builder for creating {@link TwcJwtDecoder} instances based on a {@code SecretKey}.
//     */
...
//         * @return a {@link TwcJwtDecoder.SecretKeyJwtDecoderBuilder} for further configurations
//         */
//        public TwcJwtDecoder.SecretKeyJwtDecoderBuilder macAlgorithm(MacAlgorithm macAlgorithm) {
